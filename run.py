...
def main():
    ...
    pygame.display.set_caption('Snake.io | In The Menu!')
...
def runGame():
    pygame.display.set_caption('Snake.io | Playing!')
    ...
    while True: # main game loop
        ...
        if wormCoords[HEAD]['x'] == -1 or wormCoords[HEAD]['x'] == CELLWIDTH or wormCoords[HEAD]['y'] == -1 or wormCoords[HEAD]['y'] == CELLHEIGHT:
            pygame.display.set_caption('Snake.io | Dead')
            return # game over
...
def showStartScreen():
    ...
    titleSurf1 = titleFont.render('Snake.io', True, WHITE, DARKGREEN)
    titleSurf2 = titleFont.render('Snake.io', True, GREEN)
...
def drawScore(score):
    if score == "0":
        ...
        pygame.display.set_caption('Snake.io | Playing! ({})'.format(score))
